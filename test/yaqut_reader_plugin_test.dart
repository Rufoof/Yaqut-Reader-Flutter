...
void main() {
  final YaqutReaderPluginPlatform initialPlatform =
      YaqutReaderPluginPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    YaqutReaderPlugin rufoofPlugin = YaqutReaderPlugin();
    MockYaqutReaderPluginPlatform fakePlatform =
        MockYaqutReaderPluginPlatform();
