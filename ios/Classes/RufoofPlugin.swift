...
public class RufoofPlugin: NSObject, FlutterPlugin {
    var readerBuilder: ReaderBuilder?
    var channel: FlutterMethodChannel?
    var bookId: Int?
    
    public static func register(with registrar: FlutterPluginRegistrar) {
        let instance = RufoofPlugin()
        instance.setAppearnce()
        instance.channel = FlutterMethodChannel(name: "rufoof_plugin", binaryMessenger: registrar.messenger())
...
extension RufoofPlugin: ReaderDelegate {
    ...
    public func onBookDetailsCLicked() {
        debugPrint("onBookDetailsCLicked")
    }

    public func onSaveBookClicked(position: Int) {
        debugPrint("onBookDetailsCLicked: \(position)")
    }

    public func onShareBook() {
        debugPrint("onShareBook")
    }

    public func onDownloadBook() {
        debugPrint("onDownloadBook")
    }
...
extension RufoofPlugin: StatsSessionDelegate {
